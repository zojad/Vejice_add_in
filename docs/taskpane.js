...
var isTaskpaneDebugEnabled = function isTaskpaneDebugEnabled() {
  ...
  if (typeof process !== "undefined") {
    ...
    var envOnlineVerbose = parseBooleanFlag((_process$env = process.env) === null || _process$env === void 0 ? void 0 : "false");
    if (typeof envOnlineVerbose === "boolean") return envOnlineVerbose;
    var envDebug = parseBooleanFlag((_process$env2 = process.env) === null || _process$env2 === void 0 ? void 0 : "false");
...
var refreshPendingStatus = function refreshPendingStatus() {
  ...
  setStatus("Koncano. Predlogi: ".concat(pending.length, "."));
};
